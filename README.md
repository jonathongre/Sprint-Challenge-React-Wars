...
React is a UI library that is used in various forms to create complex, rich user interfaces. You can build small, reusable pieces of UI that can be easily put together to make a large scale application. It can be used to implement headers, buttons, images etc.
...
A side effect is anything that affects something outside the scope of the function being executed. useState(), useEffect()
